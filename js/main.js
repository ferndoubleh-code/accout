/* ============================================================
   สมาร์ทบัญชี สำนักงานบัญชี — Shared Scripts
   ============================================================ */
(function () {
  'use strict';
  ...
  if (form && formOk) {
    form.addEventListener('submit', function (e) {
      ...
      fd.append('_subject', 'ข้อความจากเว็บไซต์ สมาร์ทบัญชี');
  ...
  if (CONFIG.LINE_URL) {
    ...
    panel.id = 'chatPanel';
    panel.innerHTML = '<div class="cp-head"><div class="cp-av">ว.</div><div><b>แชทกับสมาร์ทบัญชี</b><span>คุณวิชัย · ออนไลน์ · ตอบภายใน 1 ชม.</span></div></div><div class="cp-body"></div><div class="cp-quick"><button data-q="svc">📋 บริการของเรา</button><button data-q="price">💰 ราคา</button><button data-q="promo">🎁 โปรโมชัน</button><button data-q="contact">☎️ ติดต่อ</button></div><div class="cp-foot"><a class="btn btn-line" href="' + CONFIG.LINE_URL + '" target="_blank" rel="noopener">แชท Line</a><a class="btn btn-primary" href="tel:0819949980">โทร 081-994-9980</a></div>';
    ...
    bubble('bot', 'สวัสดีครับ 🙏 ยินดีต้อนรับสู่ <b>สมาร์ทบัญชี</b> สำนักงานบัญชีออนไลน์ มีอะไรให้ช่วยแนะนำได้เลยครับ');
    var replies = {
