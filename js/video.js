...
(function () {
  ...
  var SCENES = [
    { kind: 'card', dur: 5,
      html: '<div class="svp-card-in"><div class="svp-kicker">BALANCEPRO CONSULTING</div><h2>สำนักงานบัญชีบาลานซ์โปร คอนซัลติ้ง</h2><p>วิดีโอแนะนำสำนักงาน</p></div>' },
    { kind: 'img', dur: 7, src: 'images/v2-building.webp', kb: 'in',
      cap: 'สำนักงานบัญชีบาลานซ์โปร คอนซัลติ้ง พร้อมให้บริการธุรกิจทุกประเภท' },
