...
(function () {
  ...
  var SCENES = [
    ...
    { kind: 'img', dur: 7, src: 'images/v2-building.png', kb: 'in',
      cap: 'สำนักงานบัญชีสมาร์ทบัญชี พร้อมให้บริการธุรกิจทุกประเภท' },
    { kind: 'img', dur: 8, src: 'images/v2-office-wide.png', kb: 'pan',
      cap: 'บรรยากาศการทำงานภายในสำนักงาน ทีมงานพร้อมดูแลธุรกิจของคุณ' },
    { kind: 'img', dur: 7, src: 'images/v2-meeting.png', kb: 'in',
      cap: 'ประชุมทีมทุกสัปดาห์ วางแผนงานบัญชีและภาษีร่วมกัน' },
    { kind: 'img', dur: 8, src: 'images/v2-desk-work.png', kb: 'pan',
      cap: 'บันทึกบัญชีอย่างละเอียด ถูกต้องตามมาตรฐานบัญชี' },
    { kind: 'img', dur: 7, src: 'images/v2-documents.png', kb: 'in',
      cap: 'จัดเก็บเอกสารอย่างเป็นระบบ ค้นหาง่าย ปลอดภัย' },
    { kind: 'img', dur: 7, src: 'images/v2-consult.png', kb: 'pan',
      cap: 'ให้คำปรึกษาบัญชีและภาษีกับลูกค้าแบบตัวต่อตัว' },
    { kind: 'img', dur: 7, src: 'images/v2-call.png', kb: 'in',
      cap: 'ทีมงานพร้อมตอบทุกข้อสงสัย ติดต่อได้ตลอด' },
    { kind: 'img', dur: 7, src: 'images/v2-handshake.png', kb: 'pan',
      cap: 'เราเป็น Business Partner ที่เติบโตไปด้วยกันกับธุรกิจของคุณ' },
    { kind: 'img', dur: 7, src: 'images/v2-team.png', kb: 'in',
